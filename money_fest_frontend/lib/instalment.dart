...
class _InstalmentContentState extends State<InstalmentContent> {
  ...
  Widget _buildCategoryButton() {
    void addCategoryRow() {
      _showSetReminderPopup(
          context); // Panggil _showAddBalancePopup saat tombol "Category +" ditekan
    }
        ...
        DataTable(
          columns: [
            DataColumn(
              label: InkWell(
                onTap:
                    addCategoryRow, // panggil method untuk menampilkan pop-up
  ...
  void _showSetReminderPopup(BuildContext context) {
    ...
    Future<void> selectInstalmentDeadline() async {
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                TextButton(
                  onPressed: selectInstalmentDeadline,
                  child: Text(
